...
export default function AiCard() {
  return (
    <>
        ...
        <section className="nunito container mx-auto p-6 pl-10 pr-10 mb-20 h-128 flex-grow grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="nunito bg-white p-6 shadow-lg rounded-lg border border-gray-200">
                ...
                <div className="h-82 overflow-auto p-2 border border-gray-300 rounded mt-2 bg-gray-50"></div>
