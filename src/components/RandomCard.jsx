...
export default function RandomCard( {setShow, recipe } ) {
        ...
        <main className="container mx-auto pl-10 pr-10 pb-10 flex-grow nunito">
         <div className="grid md:grid-cols-2 shadow-lg p-10 rounded gap-4 bg-white">
            ...
            <div className='order-2 md:order-1'>
                ...
                <button onClick={() => setShow(true)} className="ml-20 bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 w-48 mx-auto mt-24">
                Cook this recipe
                </button>
            </div>
