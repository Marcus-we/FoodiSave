...
export default function HomePage() {
  return (
    <>
      <section className='container bg-green-600 mx-auto md:h-112 w-full h-124 grid md:grid-cols-2 shadow-md rounded-b nunito'>
          <div className=''>
          ...
          <div className='h-56 w-60 sm:h-76 sm:w-80 md:h-92 md:w-94 mx-auto'>
